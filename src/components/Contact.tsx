        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to discuss your next cloud infrastructure project? Let's connect and explore how we can work together.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-8">
                  ...
                  or simply connecting with fellow professionals in the DevOps and Cloud space.
                </p>
              </div>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social, index) => (
                    <a
                      key={index}
                      href={social.href}
                      className="p-3 bg-white rounded-lg shadow-md hover:shadow-lg text-gray-600 hover:text-blue-600 transition-all duration-300 transform hover:-translate-y-1"
